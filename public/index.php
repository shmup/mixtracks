...
const trackElements = document.querySelectorAll('#tracks li a');
...
function getCurrentTrackIndex() {
    ...
    return Array.from(trackElements).findIndex(el => {
...
function playNextTrack() {
    ...
    } else if (currentIndex + 1 < trackElements.length) {
        playTrack(trackElements[currentIndex + 1].getAttribute('href'));
    }
}
